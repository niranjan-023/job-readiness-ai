				...
				<div className="space-y-6">
					{questions.map((q, index) => (
						...
						>
							...
							{q.type === "text" && (
								<textarea
									className="w-full border border-gray-300 mt-3 p-3 rounded-lg text-gray-900 placeholder-gray-400 bg-white focus:ring-2 focus:ring-indigo-500 focus:outline-none caret-black"
